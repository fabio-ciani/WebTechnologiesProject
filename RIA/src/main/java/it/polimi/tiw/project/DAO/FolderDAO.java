...
public class FolderDAO {
	...
	public FolderBean getFolder(int folderID, int userID) throws SQLException {
		String query = "SELECT name, owner, creation_date FROM Folder WHERE id = ? AND parent_folder IS NULL AND user = ?";
