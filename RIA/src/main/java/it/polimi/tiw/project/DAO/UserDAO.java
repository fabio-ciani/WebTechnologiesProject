...
public class UserDAO {
	...
	public boolean checkEmailAvailability(String email) throws SQLException {
		String query = "SELECT COUNT(*) AS occurences FROM User WHERE email = ?";
	...
	public void registerUser(String name, String surname, String email, String pwd) throws SQLException {
	...
	public UserBean checkCredentials(String email, String pwd) throws SQLException {
		String query = "SELECT userID, email, name, surname FROM User WHERE email = ? AND pwd_hash = SHA2(?, 256)";
